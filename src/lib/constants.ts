...
export const EVENTS = [
  {
    ...
    stats: { attendees: "10000+", speakers: "150+", partners: "10+" },
    featured: true,
  },
  {
    ...
    stats: { attendees: "200+", speakers: "10+", partners: "5+" },
  featured: false,
  },
  {
    ...
    stats: { attendees: "250+", speakers: "15+", partners: "8+" },
  featured: false,
  },
  {
    ...
    location: "Ranchi",
    type: "Academic Summit",
    stats: { attendees: "250+", speakers: "15+", partners: "6+" },
  featured: false,
  },
  {
    ...
    location: "Mumbai",
    type: "Leadership Summit",
    stats: { attendees: "200+", speakers: "30+", partners: "5+" },
  featured: false,
  },
] as const;
